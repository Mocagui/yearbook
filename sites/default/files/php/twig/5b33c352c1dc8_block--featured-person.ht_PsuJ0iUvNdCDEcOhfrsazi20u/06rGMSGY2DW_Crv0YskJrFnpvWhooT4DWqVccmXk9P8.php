...
class __TwigTemplate_a4b2322848339c8ab2708b6def066ed1510b6b72647c29c348e47192d081a8a1 extends Twig_Template
{
    ...
    {
        $tags = array();
        $filters = array("upper" => 9);
        $functions = array("drupal_entity" => 10);
...
<div class=\"featured-person\">
    ...
    <div>";
        // line 10
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\twig_tweak\TwigExtension')->drupalEntity("node", ($context["featured_person_node"] ?? null), ""), "html", null, true));
        echo "</div>
</div>";
    }
...
<div class=\"featured-person\">
    ...
    <div>{{ drupal_entity('node', featured_person_node, '')}}</div>
